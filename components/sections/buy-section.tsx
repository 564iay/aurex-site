  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
        <motion.div
          className="glass-panel rounded-[2.2rem] p-8 text-center md:p-12 lg:text-left"
        ...
        >
          ...
          <div className="mt-10 rounded-[1.8rem] border border-[rgba(215,180,106,0.26)] bg-[rgba(255,255,255,0.03)] p-8 shadow-gold">
        ...
        {/* Right side left empty intentionally to frame the 3D headphone preview */}
